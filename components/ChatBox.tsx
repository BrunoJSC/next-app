...
export const ChatBox = () => {
  ...
  return (
    <>
      <button
        className="fixed bottom-8 right-8 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 h-[80px] w-[100px] rounded-full shadow z-50 flex items-center justify-center"
